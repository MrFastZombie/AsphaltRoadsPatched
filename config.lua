...
AR_config.use_Corrundum_items = settings.startup["AR-use-items-from-corrundum"].value
AR_config.use_Stone = settings.startup["AR-use-stone"].value
AR_config.use_Crude_Oil= settings.startup["AR-use-crude-oil"].value
